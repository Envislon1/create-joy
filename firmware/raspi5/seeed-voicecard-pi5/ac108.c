...
{	.iface = SNDRV_CTL_ELEM_IFACE_MIXER, .name = xname, \
	...
	.private_value = SEEED_SOC_SINGLE_VALUE(reg, shift, max, invert, chip) }
...
static int ac108_i2c_probe(SEEED_I2C_PROBE_ARGS(i2c)) {
	const struct i2c_device_id *i2c_id = SEEED_I2C_PROBE_ID(i2c);
