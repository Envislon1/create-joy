...
extern int     battery;         // 0..100, reported by the Pi power monitor
extern bool    charging;        // USB-C / dock power present
extern String  clock_hhmm;      // "14:03" — Pi is the clock master (RTC + NTP)
