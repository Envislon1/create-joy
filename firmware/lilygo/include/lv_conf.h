...
/* --- SD-backed LVGL binary images (see firmware/shared/SD_CARD_GUIDE.md) ---
   A custom 'S:' filesystem driver is registered in mb_assets.inc. This board
   has PSRAM, so we can afford to cache decoded frames and load each image
   into RAM once instead of re-reading the card line by line. */
